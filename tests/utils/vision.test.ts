...
describe('transformOpenAIToAnthropicResponse', () => {
    ...
    it('should extract reasoning from tags and create thinking block', () => {
        const openAIResponse = {
        ...
        expect(result.content[1]).toEqual({ type: 'text', text: 'I see a cat.' });
    });

    it('should map reasoning_content field to thinking block', () => {
        const openAIResponse = {
